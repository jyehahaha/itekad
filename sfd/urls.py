...
urlpatterns = [
    ...
    path('users/application', views.UsersApplicationView, name='users_application_page'), # New tab for approval user application
    path('users/approve/<int:user_id>/', views.approve_profile, name='approve_profile'),
    path('users/decline/<int:user_id>/', views.decline_profile, name='decline_profile'),
